    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ArtPiecePage',
          path: '/artPiecePage',
          builder: (context, params) => ArtPiecePageWidget(
            artPiece: params.getParam('artPiece', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'LoginPage',
        ...
        FFRoute(
          ...
          path: '/departmentHighlightsPage',
          builder: (context, params) => DepartmentHighlightsPageWidget(
            departmentId: params.getParam('departmentId', ParamType.int),
